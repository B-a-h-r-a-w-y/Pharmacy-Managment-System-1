...
public class PurchaseManager {
    private static final String PURCHASE_FILE = "/home/fikho/IdeaProjects/MyPharma/src/purchases.txt";
    ...
    private static boolean updateMedicineQuantity(String medicineName, int quantityPurchased) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("/home/fikho/IdeaProjects/MyPharma/src/medicines.txt"))) {
            for (Medicine medicine : medicines) {
